...
#param_grid = {'max_depth' : [9], 'subsample' : [0.8], 'colsample_bytree' : [0.7], 'lambda' : [1], 'gamma' : [0.3], 'min_child_weight' : [3], 'eta' : [0.037, 0.038, 0.039, 0.04, 0.041, 0.042, 0.043]}
...
test_pred = (xg.predict(dm_test) >= 0.25)
test_pred[0:20]
